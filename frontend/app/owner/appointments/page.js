...
function OwnerAppointmentsManager() {
  ...
  const handleAction = async () => {
    ...
    try {
      ...
      toast.success(
        actionType === "approve" ? "Randevu onaylandı!" : "Randevu reddedildi!"
      );
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Randevular</h1>
          <p className="text-gray-600">
            {appointments?.appointments?.length || 0} randevu
            {statusFilter !== "all" &&
              ` (${
            ...
            {appointments?.appointments?.map((appointment) => (
              <div
                ...
                className={`bg-white rounded-xl shadow-sm p-6 transition-all hover:shadow-md ${
                  ...
                  isPast(appointment.startDateTime) &&
                    ...
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <div className="mt-3">
                        ...
                        <div className="flex flex-wrap gap-2 mt-2">
                          {appointment.emailsSent?.created && (
                            <EmailStatusBadge emailSent={true} type="created" />
                          )}
                          ...
                          {appointment.emailsSent?.rejected && (
                            <EmailStatusBadge
                              emailSent={true}
                              type="rejected"
                            />
                          ...
                          {appointment.createdBy && (
                            <span className="inline-flex items-center gap-1 px-2 py-1 text-xs rounded-full bg-purple-100 text-purple-800 border border-purple-200">
                              <User size={12} />
                              Owner Tarafından Oluşturuldu
                            </span>
                          )}
                        </div>
                      </div>
                      <div className="flex flex-wrap gap-2">
                        ...
                        {/* Email Status Info */}
                        {appointment.userId?.email ? (
                          <div className="flex items-center gap-1 px-3 py-2 bg-gray-50 rounded-lg text-xs text-gray-600">
                            <Mail size={14} />
                            {appointment.userId.email}
                          </div>
                        ) : (
                          <div className="flex items-center gap-1 px-3 py-2 bg-red-50 rounded-lg text-xs text-red-600">
                            <Mail size={14} />
                            Email Yok
                          </div>
                        )}
                    ...
                    <div className="flex flex-wrap gap-3">
                      {appointment.status === "pending" && (
                        <>
                          <button
                            onClick={() =>
                              openActionModal(appointment, "approve")
                            }
                          ...
                          <button
                            onClick={() =>
                              openActionModal(appointment, "reject")
                            }
